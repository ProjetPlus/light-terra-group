    ...
    <section className="mx-auto max-w-7xl px-5 py-20 lg:px-8 lg:py-28">
      ...
      <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {activities.map((activity) => {
          ...
          return (
            <Link key={activity.id} to={"/activites/$slug" as any} params={{ slug: activity.slug } as any} className="group rounded-lg border border-border bg-card p-7 transition hover:-translate-y-1 hover:shadow-elevated">
