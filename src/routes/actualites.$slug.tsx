        ...
        {related.length ? (
          <section className="mt-16 border-t border-border pt-12">
            ...
            <div className="mt-6 grid gap-6 md:grid-cols-2">
              {related.map((news) => (
                <Link key={news.id} to={"/actualites/$slug" as any} params={{ slug: news.slug } as any} className="overflow-hidden rounded-2xl border border-border bg-card transition hover:-translate-y-1 hover:shadow-elevated">
